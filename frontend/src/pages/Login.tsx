...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-slate-900 via-indigo-950 to-slate-900 text-white p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <p className="text-indigo-200/80">Sign in to your cloud storage.</p>
        </div>

        <div className="bg-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] relative overflow-hidden group animate-in fade-in zoom-in-95 duration-500 delay-150 fill-mode-both">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-indigo-100 ml-1">Username or Email</label>
